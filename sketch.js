...
function preload(){
  kangaroo_running =   loadAnimation("assets/run1.png","assets/run2.png","assets/run3.png","assets/run4.png");
  kangaroo_collided = loadAnimation("assets/cryingBoy.png");
  jungleImage = loadImage("assets/neighbourhood.png");
  shrub1 = loadImage("assets/chocolateBar.png");
  shrub2 = loadImage("assets/candy.png");
  shrub3 = loadImage("assets/images.png");
